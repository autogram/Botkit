...
from pyrogram import CallbackQuery, Client, Message
...
def make_valid_handler_variations(update_type: object) -> List[Callable]:
    async def pure(client: Client, message: update_type):
        pass
    ...
    return [pure, no_client_annotation, with_additional_args, more_args_inbetween, sync]
